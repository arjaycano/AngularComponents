...
import {DisplaygooddayComponent} from "./components/displaygoodday/displaygoodday.component";
import {ShowgoodbuttonComponent} from "./components/showgoodbutton/showgoodbutton.component";
import {Counter2Component} from "./components/counter2/counter2.component";
import {UserbirthyearComponent} from "./components/userbirthyear/userbirthyear.component";
...
import {DisplayageComponent} from "./components/displayage/displayage.component";
...
const routes: Routes = [
  ...
  {path: 'displaygoodday', component: DisplaygooddayComponent},
  {path: 'displayage', component: DisplayageComponent},
  {path: 'showgoodbutton', component: ShowgoodbuttonComponent},
  {path: 'counter2', component: Counter2Component},
  {path: 'userbirthyear', component: UserbirthyearComponent},
  {path: 'showemail', component: ShowemailComponent},
...
@NgModule({
  ...
  declarations: [
    ...
    DisplaygooddayComponent,
    DisplayageComponent,
    ShowgoodbuttonComponent,
    Counter2Component,
    UserbirthyearComponent,
    ShowemailComponent,
    AnimelistComponent,
